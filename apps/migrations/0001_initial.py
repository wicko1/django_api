# Generated by Django 5.0.7 on 2024-09-05 11:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('admin', 'Admin'), ('user', 'User'), ('manager', 'Manager'), ('moderator', 'Moderator')], db_default='user', max_length=25)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=255)),
                ('price', models.IntegerField()),
                ('is_premium', models.BooleanField(db_default=0)),
